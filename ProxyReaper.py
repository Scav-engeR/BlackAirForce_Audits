...
if os.path.isfile(output_file):
    ...
    print(f"{Fore.RED}'proxy.txt' successfully deleted-{Fore.RESET}")

print(f"{Fore.YELLOW}Let the Reaping Begin - Expect 10mil+\n")
    ...
    try:
        ...
        if response.status_code == 200:
            with open(output_file, 'a') as file:
                ...
                print(f"{Fore.GREEN}BAGGED {Fore.WHITE}{url} {Fore.GREEN}")
        else:
            print(f"{Fore.RED}BITCH {url}{Fore.RESET}")
    except Exception as e:
        print(f"{Fore.RED}COCKSUCKA {url}{Fore.RESET}")
...
print(f"\n{Fore.WHITE}( {Fore.YELLOW}{jumlh} {Fore.WHITE}) {Fore.GREEN}Proxies bagged up u wanna check or no cunt {Fore.WHITE}({Fore.GREEN}Y{Fore.WHITE}/{Fore.RED}N{Fore.WHITE}): ", end="")
choice = 'n'
...
if choice == 'y' or choice == 'Y':
    ...
    parser.add_argument("-s", "--site", default="https://yandex.com/", help="Check with specific website like yandex.com")
    ...
    print(f"{Fore.YELLOW}DONE... Your'e welcome, By Scav-engeR !!!.\n")
