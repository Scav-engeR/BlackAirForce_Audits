...
FreeMediaHeckYeah (Collection of OSINT Tools)
...
iKy (A Tool That Collects Info From An Email and Headers)
...
ProtOSINT (Helps You Investigate Protonmail Accounts and ProtonVPN IP Addresses) 
...
Hell0 (Collection of OSINT Tools)
...
EmailAnalyzer (Used To Analyze Suspicious Emails / Extract Headers, Links and Hashes From .eml File)
...
Forensix (Google Chrome Forensic Tool Process Browsing Artifacts)
...
Hayabusa (Sigma Based Threat Hunting / Rust Script)
...
Rustling (Rust Exercises For Learning From Official Site)
https://github.com/rust-lang/rustlings/tree/main

The Rust Book (Programming Language Book)
...
crack my app (Practice reverse engineering through their challenges)
https://crackmy.app/

================================ Malware Analysis ============================================

Malware Analysis (Repo Of Collection Of Malware Samples With Analysis Reports)
https://github.com/Malwareman007/Malware_Analysis

================================== OSINT =====================================================

Linux For OSINT 21 Days
https://github.com/cipher387/linux-for-OSINT-21-day

==================================== Complete Courses ========================================

Cyber Security Course ( Tor / Dread Post - Complete Cybersecurity course from beginner to advanced)
http://dreadytofatroptsdj6io7l3xptbet6onoyno2yv7jicoxknyazubrad.onion/post/6eeee124f6eb4464eaad

====================================== Forums ================================================

CyberForums (Russian Based)
https://www.cyberforum.ru

Go 4 Expert
https://www.go4expert.com/

Hacks (Greek based / Full Tutorial learning)
https://greekhacking.gr
...
HackerOne (Bug bounty for money)
hackerone.com
...
Malware (Various Malware, Packer, Crypter, etc. Detectio And Analysis Tools)
...
Secret Scanner (Deepfence SecretScanner Can Find Unprotected Secrits In Container Images Or File Systems)
...
Netcat Terminal File Sharing { Encrypted File Transfers With Ncat }
